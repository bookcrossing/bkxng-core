...
(function ($) {
  Drupal.behaviors.getlocations_mapquest_formatter = {
    attach: function(context, settings) {
      ...
      if ($("input[id$=trafficcontrol]").prop('checked')) {
      ...
      if ($("input[id$=drawingcontrol]").prop('checked')) {
      ...
      if ($("input[id$=geolocationcontrol]").prop('checked')) {
      ...
      if ($("#edit-getlocations-mapquest-defaults-views-search-marker-enable").is('input')) {
        if ($("#edit-getlocations-mapquest-defaults-views-search-marker-enable").prop('checked')) {
      ...
      if ($("#edit-getlocations-mapquest-defaults-views-search-radshape-enable").is('input')) {
        if ($("#edit-getlocations-mapquest-defaults-views-search-radshape-enable").prop('checked')) {
