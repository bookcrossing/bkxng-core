...
/**
 * @file
 * Mobilizer theme implementation to display a front page for mobile device.
 *
 * Available variables:
    ...
    <nav id="main-menu"  role="navigation">
      <div id="dd" class="menu-navigation-container wrapper-dropdown-3" tabindex="1">
        ...
        <ul class="menu dropdown">
          <?php
          if ((variable_get('mobilizer_nav_style') == 'menu-horizontal') || (variable_get('mobilizer_nav_style') == 'menu-box')) {
            print $mobilizer_menu_custom;
          } else {
            print $mobilizer_menu_custom_drop; //drupal_render($main_menu_tree);
          }
          ?>
        </ul>
        <!-- end main-menu -->
